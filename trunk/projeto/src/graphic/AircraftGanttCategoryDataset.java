...
public class AircraftGanttCategoryDataset extends AbstractDataset
    ...
    public boolean incrementFirstCategoryIndex() {
        if (this.firstCategoryIndex + this.maximumCategoryCount < this.underlying.getColumnCount()) {
    ...
    public boolean decrementFirstCategoryIndex() {
        if (this.firstCategoryIndex == 0) {
            return false;
        } else {
            this.firstCategoryIndex--;
            fireDatasetChanged();
            if(this.firstCategoryIndex == 0) return false;
            else return true;
        }
    }
