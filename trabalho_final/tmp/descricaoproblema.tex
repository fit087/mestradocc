...
conexões entre dois voos onde o primeiro chega em um aeroporto diferente do
aeroporto de partida do voo seguinte, no entanto, existe tempo suficiente para
um voo de reposicionamento, entre os dois locais, sem violar as restrições de
tempo de solo. O custo de um arco do tipo 3 é igual a duração do voo de
